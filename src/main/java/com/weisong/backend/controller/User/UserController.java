package com.weisong.backend.controller.User;
...
import com.weisong.backend.service.User.UserUpdateMessService;
import com.weisong.backend.Token.CreateTokenUtils;
...
//              获取校验的错误结果
        ...
        loginUser.setAvatar("hard/1.jpg");
    ...
    public BlogJSONResult login(@RequestBody LoginUser loginUser){
        ...
        User userForBase;
        if (loginUser.getName().contains("@") == true){
