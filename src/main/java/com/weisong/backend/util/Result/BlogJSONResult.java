...
//    private String ok;	// 不使用
    ...
    public BlogJSONResult build(Integer status, String msg, Object data) {
    ...
    public BlogJSONResult errorMap(Object data) {
    ...
    public BlogJSONResult errorRolesMsg(String msg) {
